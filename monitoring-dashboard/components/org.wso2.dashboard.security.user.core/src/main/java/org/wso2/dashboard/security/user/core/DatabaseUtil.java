...
//        return (dataSource = new org.apache.tomcat.jdbc.pool.DataSource(poolProperties));
    ...
    private static DataSource getDataSource(String dataSourceName) {
        try {
            ...
            config.setDriverClassName(System.getProperty("datasource.abc.driver"));
            config.setJdbcUrl(System.getProperty("datasource.abc.url"));
            config.setUsername(System.getProperty("datasource.abc.username"));
            config.setPassword(System.getProperty("datasource.abc.password"));

            if (System.getProperty("pool_options.maxActive") != null &&
                    !System.getProperty("pool_options.maxActive").trim().equals("")) {
                config.setMaximumPoolSize(Integer.parseInt(System.getProperty("pool_options.maxActive")));
            } else {
                config.setMaximumPoolSize(DEFAULT_MAX_ACTIVE);
            }
...
//        poolProperties.setPassword(realmConfig.getUserStoreProperty(JDBCRealmConstants.PASSWORD));
        ...
        configureAdvancedProperties2(config, realmConfig);
...
//                .DEFAULT_TRANSACTION_ISOLATION));
    ...
    private static void configureAdvancedProperties2(HikariConfig config, RealmConfiguration realmConfig) {
        //        todo tobe implemented
...
//            todo
//            org.wso2.micro.integrator.security.user.core.util.DatabaseUtil.closeAllConnections(null, rs, prepStmt);
        }
    }
    ...
    public static void udpateUserRoleMappingInBatchModeForInternalRoles(Connection dbConnection,
        ...
        try {
            ...
            org.wso2.micro.integrator.security.user.core.util.DatabaseUtil.closeAllConnections(null, prepStmt);
        }
    }
    ...
    public static void udpateUserRoleMappingWithExactParams(Connection dbConnection, String sqlStmt,
        ...
        try {
            ...
            org.wso2.micro.integrator.security.user.core.util.DatabaseUtil.closeAllConnections(null, ps);
        }
    }
