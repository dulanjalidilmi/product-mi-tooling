...
public class DelegatesUtil {
    ...
    public static JsonArray getResourceResultList(String groupId, String nodeId, String type, 
        ...
        // todo remove listKeyName part
//        logger.info("artifact list: " + type + " " + artifacts.toString());
//        logger.info("active list: " + type + " " + artifacts.get(listKeyName).getAsJsonArray().toString());
        if (type.equals(Constants.CARBON_APPLICATIONS)) {
            ...
            logger.info("capp merged list: " + type + " " + allCApps.toString());
            return allCApps;
        } else {
